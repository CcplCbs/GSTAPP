...
import { HeaderFooterLoginComponent } from 'src/app/theme/auth/login/header-footer-login/header-footer-login.component';
...
export class AdminComponent implements OnInit, OnDestroy {
  ...
  constructor(public menuItems: MenuItems, public router: Router, private _detailService: DetailService) {
    this.animateSidebar = '';
    this.navType = 'st2';
  ...
  logOut() {
    ...
    this._detailService.logOut(obj).subscribe(response => {
      Swal.fire({
        title: 'Logout',
        ...
        if (result.isConfirmed) {
          ...
          this.router.navigate(['/auth/login/header-footer']);
        }
      });
    });
